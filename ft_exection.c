...
/*   Updated: 2024/05/05 01:35:43 by abquaoub         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_exec_recursive(t_list *head, t_data *data)
{
	...
	if (p == 0)
	{
		ft_nested_pip_ex(head->new_list->new_list, data, data->out, data->in);
		exit(1);
	}
	wait(NULL);
}
